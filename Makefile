...
OBJECTS_ACR = advancedClassificationRecurtion.o
...
advancedClassificationRecurtion.o: advancedClassificationRecurtion.c $(HEADER)
	$(CC) $(FLAGS) -fPIC -c advancedClassificationRecurtion.c
